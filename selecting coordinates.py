...
import serial
#import camerav.py
path="C:\\Users\\vivekz\\Desktop\\farmbot\\plant detection\\plant-detection-master\\plant_detection\\p2c_test_calibration.jpg" 
oimg=cv2.imread(path,1)  
windowname="window"
#so=serial.Serial(port="COM4",baudrate=9600,timeout=2,stopbits=serial.STOPBITS_ONE)
right_clicks=list()
img=cv2.resize(oimg,(512,512))
cmtopixelx=100/512.0
cmtopixely=100/512.0
x=4
cm=100/20
r=cm*x
p=int(r)
