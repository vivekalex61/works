...
def image_callback(ros_image):
    ...
    try:
        ...
        imgtocv=bridge.imgmsg_to_cv2(ros_image,"bgr8")
        #cv2.imshow("Image window",imgtocv)
        
        detect_ball_in_a_frame(imgtocv)
...
def main(args):
    ...
    rospy.init_node("balltracking",anonymous=True)
#    publisher=rospy.Publisher("chatter",Image,queue_size=10)
